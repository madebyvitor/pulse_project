  ...
  return (
    <section className="py-24">
      <div className="container px-6 mx-auto max-w-7xl">
        <div className="relative p-12 md:p-24 overflow-hidden rounded-3xl bg-[#111111] border border-zinc-800 text-center">
          {/* Background glow */}
          ...
          <div className="relative z-10">
            ...
            <h2 className="mb-6 text-3xl font-bold md:text-6xl text-white leading-tight">
