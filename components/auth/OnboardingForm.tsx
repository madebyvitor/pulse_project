...
import { OnboardingSubmitButton } from '@/components/auth/OnboardingSubmitButton'
...
export function OnboardingForm() {
  ...
  return (
    <>
        ...
        <div className="w-full max-w-sm relative z-10 flex flex-col items-center gap-8">
          ...
          >
            <header className="mb-7">
              <h1 className="text-xl font-bold text-white mb-1.5">{t('cardTitle')}</h1>
              <p className="text-[#888888] text-sm leading-relaxed">{t('cardSubtitle')}</p>
            </header>

            <form action={completeOnboardingAction} noValidate className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={[
                      ...
                      'focus:ring-4 focus:ring-[#C6FF4A]/10 border-[#222222] focus:border-[#C6FF4A]/30',
                    ].join(' ')}
                  />
                </div>
              </div>

              <OnboardingSubmitButton label={t('submit')} />
            </form>
          </motion.div>
      ...
      <Toast show={false} message={t('success')} type="success" onClose={() => {}} />
    </>
  )
}
